...
<div class="content">
    <div class="container">
        <h1 style="display:none">THÀNH</h1>
        <div class="row">
...
<footer id="footer">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-3">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="http://localhost/QLBanDoAn/index.php">Trang chủ</a></li>
    ...
    <div class="bottom-footer">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-5"> © Copyright belongs to Lotteria</div>
                <div class="col-xs-12 col-sm-7">
                    <ul class="list-unstyled">
                        <li><a href="http://localhost/QLBanDoAn">Trang chủ</a></li>
                        <li><a href="gioi-thieu">Giới thiệu</a></li>
                        <li><a href="tin-tuc">Tin tức</a></li>
